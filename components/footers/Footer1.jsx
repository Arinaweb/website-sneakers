      ...
      <div className="container">
        <div className="row pb-120 pb-sm-80 pb-xs-50">
          <div className="col-md-4 col-lg-3 text-gray mb-sm-50">
            ...
            <p>
              Sneaker Restore este un atelier complet dedicat curatarii, repararii si restaurarii sneakersilor. 
            </p>
            ...
            <div className="clearlinks">
              <strong>E.</strong>
              <a href="mailto:sneakerrestore.ro@gmail.com">sneakerrestore.ro@gmail.com</a>
            </div>
          </div>
          <div className="col-md-7 offset-md-1 offset-lg-2">
            <div className="row mt-n30">
              ...
              <div className="col-sm-4 mt-30">
                <h3 className="fw-title">Despre Companie</h3>
        ...
        <div className="row text-gray">
          <div className="col-md-4 col-lg-3">
            <b>© Sneaker Restore {new Date().getFullYear()}.</b>
          </div>
          <div className="col-md-7 offset-md-1 offset-lg-2 clearfix">
            <b>Bucuresti, Romania</b>
            {/* Back to Top Link */}
