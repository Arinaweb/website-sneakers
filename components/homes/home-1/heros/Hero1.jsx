          ...
          <div className="row">
            ...
            <div className="col-md-6 d-flex align-items-center mb-sm-60">
              <div>
                ...
                >
                  Sneaker Restore Studio
                </h2>
                <h1 className="hs-title-1 mb-30">
                  <AnimatedText
                    text={"Reda viata sneakersilor tai preferati"}
                  />
                </h1>
                ...
                <p
                  ...
                  data-wow-duration="1.2s"
                >
                  Sneaker Restore este un atelier complet dedicat curatarii, repararii si restaurarii sneakersilor. Oferim servicii profesionale pentru a pastra look-ul si calitatea originala a incaltarilor tale.
                </p>
                <div
            ...
            <div className="col-md-5 offset-md-1 d-flex align-items-center">
              <div className="stack-images">
                ...
                >
                  ...
                  >
                    <Image
                      src="/assets/images/sneakers/reconditionare adidasi31.jpeg"
                ...
                >
                  ...
                  >
                    <Image
                      width={600}
                      height={800}
                      src="/assets/images/sneakers/reconditionare adidasi32.jpeg"
                      alt="Image Description"
                    />
                  </div>
                </div>
                ...
                >
                  ...
                  >
                    <Image
                      width={600}
                      height={800}
                      src="/assets/images/sneakers/reconditionare adidasi9.jpeg"
                      alt="Image Description"
                    />
                  </div>
                </div>
        ...
        >
          <div className="container">
            <a href="#about" className="scroll-down-1">
              ...
              <div className="scroll-down-1-text">Mai multe detalii</div>
            </a>
          </div>
        </div>
        {/* End Scroll Down */}
