export const strongMultiPages = [
  { href: "/strong-multi-page", text: "Acasa" },
...
export const strongMultiPagesDark = [
  { href: "/strong-multi-page-dark", text: "Acasa" },
...
export const slickMultipages = [
  { href: "/slick-multi-page", text: "Acasa" },
...
export const slickMultipagesDark = [
  { href: "/slick-multi-page-dark", text: "Acasa" },
...
export const modernMultipage = [
  { id: 1, href: "/modern-multi-page", text: "Acasa" },
...
export const modernMultipageDark = [
  { id: 1, href: "/modern-multi-page-dark", text: "Acasa" },
...
export const modernOnepage = [
  { href: "#home", text: "Acasa", className: "active", dataBtnAnimate: "y" },
...
export const gradientMultipage = [
  { href: "/gradient-multi-page", text: "Acasa", active: true },
...
export const gradientMultipageDark = [
  { href: "/gradient-multi-page-dark", text: "Acasa", active: true },
...
export const fancyMultipage = [
  { href: "/fancy-multi-page", text: "Acasa", class: "active" },
...
export const fancyMultipageDark = [
  { href: "/fancy-multi-page-dark", text: "Acasa", class: "active" },
...
export const elegantMultipage = [
  { href: "/elegant-multi-page", text: "Acasa" },
...
export const elegantMultipageDark = [
  { href: "/elegant-multi-page-dark", text: "Acasa" },
...
export const corporateMultipage = [
  { href: "/corporate-multi-page", text: "Acasa" },
...
export const corporateMultipageDark = [
  { href: "/corporate-multi-page-dark", text: "Acasa" },
...
export const brutalistMultipage = [
  { href: "/brutalist-multi-page", text: "Acasa", active: true },
...
export const brutalistMultipageDark = [
  { href: "/brutalist-multi-page-dark", text: "Acasa", active: true },
...
export const boldMultipage = [
  { href: "/bold-multi-page", text: "Acasa", active: false },
...
export const boldMultipageDark = [
  { href: "/bold-multi-page-dark", text: "Acasa", active: false },
