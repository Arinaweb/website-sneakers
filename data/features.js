export const featureItems = [
  {
    ...
    title: "Cat dureaza o reconditionare?",
    description:
      "In general, procesul dureaza 5 zile lucratoare, iar in perioadele aglomerate termenul de retur se poate intinde pana la 10-15 zile lucratoare, in functie de tipul interventiei si de gradul de uzura al sneakerșilor.",
  },
  {
    id: 2,
    className: "col-md-4 col-lg-3 d-flex align-items-stretch mb-sm-30",
    ...
    title: "Ce tipuri de pantofi reconditionati?",
    description:
      "Ne ocupam de tot felul de incaltaminte, dar mai ales de sneakers din piele, textil, mesh sau combinatii, atat de lifestyle, cat si modele de colectie sau rare.",
  },
  {
    id: 3,
    ...
    title: "Ce se intampla daca nu se pot repara?",
    description:
      "Daca pantofii nu pot fi reconditionati in siguranta, te anuntam inainte si nu continuam fara acordul tau.",
  },
];
